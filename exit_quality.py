...
exit_quality_gauge = {'axis': {'range': [0, 100]},
                      'bar': {'color': "black"},
                      'steps': [
...
def update_output(start_date, end_date, full_period, within_one_day, within_one_week, within_one_month, stock_code, buy_price, sell_price):
