...
from pages.analysis import overview, exit_quality, reward_risk, win_loss, benchmark_comparison, diversification
...
pages = [overview, win_loss, reward_risk, exit_quality,benchmark_comparison, diversification]
